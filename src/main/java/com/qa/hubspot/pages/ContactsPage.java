...
public class ContactsPage extends BasePage {
	...
	public String getConatctsPageTitle() {
		return elementUtil.waitForTitleToBePresent(Constants.CONTACTS_PAGE_TITLE, dur);
	}

	public String getContactsPageHeader() {
		elementUtil.waitForElementToBeVisible(header, dur);
		return elementUtil.doGetText(header);
	}

	public void createContact(String email, String firstName, String lastName, String jobTitle) {
		elementUtil.clickWhenReady(createContactPrimary, dur);
